...
| Docs | 23 ADRs in [`docs/adr/`](adr/README.md), design doc in sync |
| Tests | 166 backend, 19 web |

Remaining for the MVP: the agent, the demo scenario, and deployment (commits 5-7 below).
